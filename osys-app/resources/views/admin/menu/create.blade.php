	...
	<div class="col-md-6">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				@endif
				<form action="{{url('/admin/menu/create')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-9">
								<select name="data[category_id]" class="form-control">
									...
									<option @if(old('data.category_id')==$category->id){{"selected"}}@endif value="{{$category->id}}">{{$category->name}}</option>
									@endforeach
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<textarea type="text" name="data[description]" class="form-control">{{old('data.description')}}</textarea>
							</div>
						</div>
					</div>
				...
				<table id="picture-table" class="table table-responsible table-bordered">
					...
					@if(!empty(old('picture')))
						...
						<tr>
							...
							<td><button data-id="{{$id}}" class="btn btn-danger delbtn">Delete</button></td>
						</tr>
						@endforeach
					@endif
					</tbody>
